...
public:
	...
	bool isValid(string input, map<char, int> index);
	bool remove(string input, map<char, int> index);
	void print();
...
private:
	...
	void convertToIndexes(map<char, int> index);
...
void Board::convertToIndexes(map<char, int> index)
{
...
bool Board::isValid(string input, map<char, int> index)
{
	ifstream dictionary;
	string word, content;
	int y, x, ix, iy;
...
bool  Board::remove(string input, map<char, int> index)
{
