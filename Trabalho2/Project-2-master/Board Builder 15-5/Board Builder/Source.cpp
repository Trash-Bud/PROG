...
int main()
{
	...
	while (true)
	{
		...
		if (size1 < 5 || size1 > 20 || size2 < 5 || size2 > 20)
		{
			cout << endl << "Invalid board size! Please select one between 5x5 and 20x20!" << endl << endl;
		}
		else
			break;
	}
